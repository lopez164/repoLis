...
import aplicacionlogistica.distribucion.Threads.HiloListaDeNumeroDeManifiestosPendientes;
 ...
 * @author VLI_488
 */
public class IngresoAlSistemaMantenimientos extends javax.swing.JFrame {
        ...
        try {
            ...
            if (!CConexiones.hayConexion(ini.getCadenaRemota(), ini.getUsuarioBDRemota(), ini.getClaveBDRemota())) {
                ...
                try {
                    ...
                    Logger.getLogger(IngresoAlSistemaMantenimientos.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void initComponents() {
        ...
        panelFotografia2Layout.setHorizontalGroup(
            ...
            .addGroup(panelFotografia2Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelFotografia2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panelFotografia1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/logos/logoAldPlus.png"))); // NOI18N
        ...
        try {
            ...
            switch (ini.getUser().getTipoAcceso()) {
                ...
                case 6:
                    ...
                    formMantenimientos.setTitle("Sistema de Información Logistica    -- Usuario de Sistema: " + this.ini.getUser().getNombres() + " " + this.ini.getUser().getApellidos());
                    dispose();
    ...
    private void iniciarVariables() throws InterruptedException {
        ...
        if (CConexiones.hayConexion(ini.getCadenaRemota(), ini.getUsuarioBDRemota(), ini.getClaveBDRemota())) {
           ...
           // new Thread(new HiloListadoDestinosFacturas(this.ini, this.barraInferior, this.barraSuperior, this.totalFilasDeConsultas, this.contadorDeRegistros)).start();
            ...
            //new Thread(new HiloListadoDeManifiestosSinDescargar(this.ini, this.barraInferior, this.barraSuperior, this.totalFilasDeConsultas, this.contadorDeRegistros)).start();
