 ...
 * @author VLI_488
 */
public class FIngresarDescuentoClientes extends javax.swing.JInternalFrame {

    KeyboardFocusManager manager = KeyboardFocusManager.getCurrentKeyboardFocusManager();

    public boolean actualizar;
    public boolean estaOcupadoGrabando = false;
    public CFacturas factura = null;
    public CDescuentosPorFactura descuento=null;
     ...
     * @param ini
     */
    public FIngresarDescuentoClientes(Inicio ini) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Formulario para el ingreso de Descuentos para los clientes");
        ...
        pnlDescuento.setBackground(new java.awt.Color(165, 252, 166));
        pnlDescuento.setBorder(javax.swing.BorderFactory.createTitledBorder("Descuento para el cliente"));
        ...
        jLabel17.setText("Formulario de Descuentos Clientes ");
    ...
    private void grabar() throws HeadlessException {
        ...
        if (x == JOptionPane.OK_OPTION) {
            descuento = new CDescuentosPorFactura(ini);
            descuento.setActivo(1);
            descuento.setFlag(1);
            descuento.setNumeroDocumento(txtNumeroFormato.getText().trim());
            descuento.setNumeroFactura(txtNumeroFactura.getText().trim());
            descuento.setValorDescuento(Double.parseDouble(txtValorDescuento.getText().trim()));
            ...
            if (validar()) {
                  ...
                  new Thread(new HiloGuardarDescuentoPorFactura(this)).start();
                actualizar = false;
            } else {
    ...
    private void txtNumeroFacturaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNumeroFacturaKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            new Thread(new HiloConsultarFacturaParaDescuento(this)).start();
...
//            txtEmail.setText(sucursal.getEmailSucursal());
            ...
            Logger.getLogger(FIngresarDescuentoClientes.class.getName()).log(Level.SEVERE, null, ex);
...
//            }
    ...
    public boolean consultarFactura() {
        ...
        try {
            factura = new CFacturas(ini, txtNumeroFactura.getText().trim());

            factura.setListaCProductosPorFactura(false);
            
            if (factura.getNumeroDeFactura() != null) {
                encontrado = true;
                ...
                txtCodigoCliente.setText(factura.getCodigoDeCliente());
                txtCodigoCliente2.setText(factura.getCodigoDeCliente());
                txtDireccion.setText(factura.getDireccionDeCliente());
                txtEmail.setText(factura.getEmailCliente());
                txtEstadoFactura.setText(factura.getNombreEstadoFactura());
