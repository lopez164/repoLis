 ...
 * @author Usuario
 */
public class HiloCargarFormulariosAuxiliarLogistica implements Runnable {

    static boolean band;

    PrincipalAuxiliarLogistica form;
    Inicio ini;
     ...
     * @param form
     */
    public HiloCargarFormulariosAuxiliarLogistica(PrincipalAuxiliarLogistica form) {
        this.form = form;
        this.ini = form.ini;
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(HiloCargarFormulariosAuxiliarLogistica.class.getName()).log(Level.SEVERE, null, ex);
        }
