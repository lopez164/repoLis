 ...
 * @author Usuario
 */
public class JcArchivoExcelFacturasCamdun  {//{implements Runnable {
    ...
    public JcArchivoExcelFacturasCamdun(int tiempo, FImportarArchivoExcel buBd, File file,Inicio ini) {
        this.buBd=buBd;
        this.file=file;
        this.ini=ini;
//        try {
        ...
        try {
            ...
            while (rows.hasNext()) {
                try{
                      ...
                      factura=valor;
                      sql+= "'" + valor + "',";
                      //tipo=row.getCell(20).getCellType(); //fechaDeVenta
                       tipo=row.getCell(9).getCellType(); //fechaDeVenta
                      sql+= "'" + ReadRow(tipo, row, 9).trim()+ "',"; 
                      //sql+= "'" + ReadRow(tipo, row, 20).trim() + "',"; 
               ...
               // System.out.println("factura a ingresar" +  ";(" + i + ") " + sql);
                    ...
                    buBd.txtErrores.setText(buBd.mensaje);
                     Logger.getLogger(JcArchivoExcelFacturasCamdun.class.getName()).log(Level.SEVERE, null, ex + ";(" + i + ") " + sql);
