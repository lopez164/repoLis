 ...
 * @author Usuario
 */
public class JcArchivoExcelProductosCamdun_2 {//implements Runnable {
    ...
    public JcArchivoExcelProductosCamdun_2(int tiempo, FImportarArchivoExcel buBd, File file, Inicio ini) {
        this.buBd = buBd;
        this.file = file;
        this.ini = ini;
    ...
    private void insertarProductosCamdun() {
        ...
        try {
            ...
            buBd.mensaje += "Error al insertar dato Producto #  " + producto + "cliente :" + cliente + "  factura : " + factura + "\n";
            buBd.txtErrores.setText(buBd.mensaje);
            Logger.getLogger(JcArchivoExcelProductosCamdun_2.class.getName()).log(Level.SEVERE, null, ex + ";(" + i + ") " + sql);
