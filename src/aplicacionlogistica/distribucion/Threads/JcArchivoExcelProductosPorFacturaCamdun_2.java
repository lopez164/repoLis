 ...
 * @author Usuario
 */
public class JcArchivoExcelProductosPorFacturaCamdun_2
implements Runnable {
  ...
  int porcentajeBarraSuperior;
    ...
    public JcArchivoExcelProductosPorFacturaCamdun_2(int tiempo, FImportarArchivoExcel form, File file, Inicio ini) {
        this.form = form;
        this.file = file;
        this.ini = ini;
    ...
    public void ingresarDatos() {
        try {
            ...
            Logger.getLogger(JcArchivoExcelProductosPorFacturaCamdun_2.class.getName()).log(Level.SEVERE, null, ex);
        }
            ...
            while (rows.hasNext()) {
                try {
                   ...
                   // FLAG
                    ...
                    form.mensaje += "Error al insertar dato Cliente " + cliente + " , establecimiento : " + establecimiento + " factuta # : " + factura + "\n";
      ...
      int numeroFilas;
        ...
        try {
            ...
            form.mensaje += "Error al insertar dato producto en la factura # " + factura + "cliente " + cliente + "\n";
            form.txtErrores.setText(form.mensaje);
            Logger.getLogger(JcArchivoExcelProductosPorFacturaCamdun_2.class.getName()).log(Level.SEVERE, null, ex + ";(" + contadorDeFilas + ") " + sql);
            System.out.println("Error en insertar cliente Camdun" + ex + ";(" +contadorDeFilas+ ") " + sql);
