 ...
 * @author Usuario
 */
public class FCrearCargos  extends javax.swing.JInternalFrame {
...
//private FResidentes residente = (FResidentes)this.getParent();//
 ...
 public FCrearCargos(Inicio  ini) {
        initComponents();
        this.setTitle("Formulario para la gestion de Cargos");
        lblIdCargos.setText("Id. Cargo : ");
        chkActivo.setText("Cargo Activo");
        this.ini=ini;
       // this.user=ini.getUser();
        ...
        new Thread(new HiloFcrearCargos(ini, this, "listaDeCargos")).start();
 }
    ...
    private void initComponents() {
        ...
        txtnombreCargo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtnombreCargoFocusGained(evt);
            }
        });
        txtnombreCargo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtnombreCargoKeyPressed(evt);
            }
        });
        ...
        if (tblCargos.getColumnModel().getColumnCount() > 0) {
            ...
            tblCargos.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblCargos.getColumnModel().getColumn(1).setResizable(false);
            tblCargos.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblCargos.getColumnModel().getColumn(2).setResizable(false);
            tblCargos.getColumnModel().getColumn(2).setPreferredWidth(50);
        }
        ...
        lblIdCargos.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblIdCargos.setText(" ");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(txtnombreCargo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 449, Short.MAX_VALUE)))
    ...
    private void tblCargosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCargosMouseClicked
        ...
        new Thread(new HiloFcrearCargos(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblCargosMouseClicked

    private void txtnombreCargoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnombreCargoKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
           btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
        }
    }//GEN-LAST:event_txtnombreCargoKeyPressed

    private void txtnombreCargoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtnombreCargoFocusGained
        txtnombreCargo.setSelectionStart(0);
        txtnombreCargo.setSelectionEnd(txtnombreCargo.getText().length());
    }//GEN-LAST:event_txtnombreCargoFocusGained
...
btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
    ...
    public void grabar() throws HeadlessException {
        if (!txtnombreCargo.getText().isEmpty()) {
            ...
            if (x == 0) {
                  new Thread(new HiloFcrearCargos(ini, this, "guardar")).start();
            }
    ...
    private void chkActivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkActivoActionPerformed
        if(chkActivo.isSelected()){
            chkActivo.setText("Cargo activo");
             ...
             chkActivo.setText("Cargo No Activo");
        }
    ...
    public javax.swing.JLabel lblIdCargos;
 ...
 public boolean validar() {
        ...
        mensaje = "";
        if (txtnombreCargo.getText().isEmpty()) {
            mensaje += "No ha colocado el nombre del Cargo " + "  \n";
            verificado = false;
        }
