 ...
 * @author Usuario
 */
public class FCrearCentrosDeCosto  extends javax.swing.JInternalFrame {
...
String mensaje;
Inicio ini;
public CCentrosDeCosto centroDeCosto;
...
//private FResidentes residente = (FResidentes)this.getParent();//
     ...
     */
    public FCrearCentrosDeCosto() {
       initComponents();
       txtnombreCentroDeCosto.requestFocus();
    }
    
    
    
 public FCrearCentrosDeCosto(Inicio  ini) {
        initComponents();
        this.setTitle("Formulario para la gestion de Centros de Costo");
        lblIdCentroDeCosto.setText("Id. Centro de Costo : ");
        chkActivo.setText("Centro de Costo Activo");
       ...
       // this.user=ini.getUser();
        ...
        txtnombreCentroDeCosto.setEnabled(false);
        new Thread(new HiloFcrearCentrosDeCosto(ini, this, "listaDeCentrosDeCosto")).start();
 }
    ...
    private void initComponents() {
        ...
        lblNombreCentroDeCosto = new javax.swing.JLabel();
        txtnombreCentroDeCosto = new javax.swing.JTextField();
        jScrollPane3 = new javax.swing.JScrollPane();
        tblCentrosDeCosto = new javax.swing.JTable();
        chkActivo = new javax.swing.JCheckBox();
        lblIdCentroDeCosto = new javax.swing.JLabel();
        ...
        txtnombreCentroDeCosto.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtnombreCentroDeCostoFocusGained(evt);
            }
        });
        txtnombreCentroDeCosto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtnombreCentroDeCostoActionPerformed(evt);
            }
        });
        txtnombreCentroDeCosto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtnombreCentroDeCostoKeyPressed(evt);
            }
        });

        tblCentrosDeCosto.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "id", "Nombre Centro de Costo", "Activo"
            }
        ) {
        ...
        tblCentrosDeCosto.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tblCentrosDeCosto.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblCentrosDeCostoMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblCentrosDeCosto);
        if (tblCentrosDeCosto.getColumnModel().getColumnCount() > 0) {
            tblCentrosDeCosto.getColumnModel().getColumn(0).setResizable(false);
            tblCentrosDeCosto.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblCentrosDeCosto.getColumnModel().getColumn(1).setResizable(false);
            tblCentrosDeCosto.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblCentrosDeCosto.getColumnModel().getColumn(2).setResizable(false);
            tblCentrosDeCosto.getColumnModel().getColumn(2).setPreferredWidth(50);
        }
        ...
        lblIdCentroDeCosto.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblIdCentroDeCosto)
                    .addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(lblNombreCentroDeCosto, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addComponent(txtnombreCentroDeCosto, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 449, Short.MAX_VALUE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addComponent(lblIdCentroDeCosto)
                .addGap(7, 7, 7)
                .addComponent(lblNombreCentroDeCosto)
                .addGap(1, 1, 1)
                .addComponent(txtnombreCentroDeCosto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tblCentrosDeCostoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCentrosDeCostoMouseClicked
        // TODO add your handling code here:

        new Thread(new HiloFcrearCentrosDeCosto(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblCentrosDeCostoMouseClicked

    private void txtnombreCentroDeCostoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnombreCentroDeCostoKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
           btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
        }
    }//GEN-LAST:event_txtnombreCentroDeCostoKeyPressed

    private void txtnombreCentroDeCostoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtnombreCentroDeCostoFocusGained
        txtnombreCentroDeCosto.setSelectionStart(0);
        txtnombreCentroDeCosto.setSelectionEnd(txtnombreCentroDeCosto.getText().length());
    }//GEN-LAST:event_txtnombreCentroDeCostoFocusGained
    ...
    public void cancelar() {
        actualizar=false;
        txtnombreCentroDeCosto.setText("");
        chkActivo.setEnabled(false);
        chkActivo.setSelected(false);
        lblIdCentroDeCosto.setVisible(false);
 btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
        jBtnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Create.png"))); // NOI18N
        btnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/grabar.png"))); // NOI18N
       jBtnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Save.png")));
        ...
        tblCentrosDeCosto.setEnabled(true);
    }
    ...
    public void nuevo() {
        if (actualizar) {
            ...
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
            txtnombreCentroDeCosto.setEnabled(true);
            ...
            txtnombreCentroDeCosto.requestFocus();
            chkActivo.setSelected(true);
            tblCentrosDeCosto.setEnabled(false);
            btnNuevo.setEnabled(false);
            jBtnNuevo.setEnabled(false);
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
    ...
    public void grabar() throws HeadlessException {
        if (!txtnombreCentroDeCosto.getText().isEmpty()) {
            int x = JOptionPane.showConfirmDialog(this, "Desea guardar el registro ?", "Guardar registro", 0);
            if (x == 0) {
                  new Thread(new HiloFcrearCentrosDeCosto(ini, this, "guardar")).start();
            }
    ...
    private void chkActivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkActivoActionPerformed
        if(chkActivo.isSelected()){
            chkActivo.setText("Centro de Costo activo");
             ...
             chkActivo.setText("Centro de Costo No Activo");
        }
    ...
    private void txtnombreCentroDeCostoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtnombreCentroDeCostoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtnombreCentroDeCostoActionPerformed
    ...
    public javax.swing.JLabel lblIdCentroDeCosto;
    private javax.swing.JLabel lblNombreCentroDeCosto;
    public javax.swing.JTable tblCentrosDeCosto;
    public javax.swing.JTextField txtnombreCentroDeCosto;
    // End of variables declaration//GEN-END:variables
 public boolean validar() {
        boolean verificado = true;
        mensaje = "";
        if (txtnombreCentroDeCosto.getText().isEmpty()) {
            mensaje += "No ha colocado el nombre del Centro de Costo " + "  \n";
            verificado = false;
        }
