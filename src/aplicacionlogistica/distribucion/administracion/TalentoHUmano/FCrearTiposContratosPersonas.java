 ...
 * @author Usuario
 */
public class FCrearTiposContratosPersonas  extends javax.swing.JInternalFrame {
...
String mensaje;
Inicio ini;
public CTiposDeContratosPersonas tipoContrato;
...
//private FResidentes residente = (FResidentes)this.getParent();//
     ...
     */
    public FCrearTiposContratosPersonas() {
       initComponents();
       txtnombreTipoContrato.requestFocus();
    }
    
    
    
 public FCrearTiposContratosPersonas(Inicio  ini) {
        initComponents();
        this.setTitle("Formulario para la gestion de Tipos De Contrato");
        lblIdTipoContrato.setText("Id. Tipo de Contrato : ");
       ...
       // this.user=ini.getUser();
        ...
        txtnombreTipoContrato.setEnabled(false);
        new Thread(new HiloFcrearTiposContratosPersonas(ini, this, "listaDeTiposDeContratos")).start();
 }
    ...
    private void initComponents() {
        ...
        lblNombreTipoContrato = new javax.swing.JLabel();
        txtnombreTipoContrato = new javax.swing.JTextField();
        jScrollPane3 = new javax.swing.JScrollPane();
        tblTiposContratos = new javax.swing.JTable();
        ...
        txtnombreTipoContrato.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtnombreTipoContratoFocusGained(evt);
            }
        });
        txtnombreTipoContrato.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtnombreTipoContratoKeyPressed(evt);
            }
        });

        tblTiposContratos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblTiposContratos.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tblTiposContratos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblTiposContratosMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblTiposContratos);
        if (tblTiposContratos.getColumnModel().getColumnCount() > 0) {
            tblTiposContratos.getColumnModel().getColumn(0).setResizable(false);
            tblTiposContratos.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblTiposContratos.getColumnModel().getColumn(1).setResizable(false);
            tblTiposContratos.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblTiposContratos.getColumnModel().getColumn(2).setResizable(false);
            tblTiposContratos.getColumnModel().getColumn(2).setPreferredWidth(50);
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(lblNombreTipoContrato, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addComponent(txtnombreTipoContrato, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 449, Short.MAX_VALUE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addComponent(lblIdTipoContrato)
                .addGap(7, 7, 7)
                .addComponent(lblNombreTipoContrato)
                .addGap(1, 1, 1)
    ...
    private void tblTiposContratosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTiposContratosMouseClicked
        // TODO add your handling code here:

        new Thread(new HiloFcrearTiposContratosPersonas(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblTiposContratosMouseClicked

    private void txtnombreTipoContratoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnombreTipoContratoKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
           btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
        }
    }//GEN-LAST:event_txtnombreTipoContratoKeyPressed

    private void txtnombreTipoContratoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtnombreTipoContratoFocusGained
        txtnombreTipoContrato.setSelectionStart(0);
        txtnombreTipoContrato.setSelectionEnd(txtnombreTipoContrato.getText().length());
    }//GEN-LAST:event_txtnombreTipoContratoFocusGained
...
btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
       ...
       jBtnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Save.png")));
        ...
        tblTiposContratos.setEnabled(true);
    }
    ...
    public void nuevo() {
        if (actualizar) {
            ...
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
            txtnombreTipoContrato.setEnabled(true);
            ...
            txtnombreTipoContrato.requestFocus();
            chkActivo.setSelected(true);
            tblTiposContratos.setEnabled(false);
            btnNuevo.setEnabled(false);
            jBtnNuevo.setEnabled(false);
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
    ...
    public void grabar() throws HeadlessException {
        if (!txtnombreTipoContrato.getText().isEmpty()) {
            int x = JOptionPane.showConfirmDialog(this, "Desea guardar el registro ?", "Guardar registro", 0);
            if (x == 0) {
                  new Thread(new HiloFcrearTiposContratosPersonas(ini, this, "guardar")).start();
            }
    ...
    private javax.swing.JLabel lblNombreTipoContrato;
    public javax.swing.JTable tblTiposContratos;
    public javax.swing.JTextField txtnombreTipoContrato;
    // End of variables declaration//GEN-END:variables
 public boolean validar() {
        boolean verificado = true;
        mensaje = "";
        if (txtnombreTipoContrato.getText().isEmpty()) {
            mensaje += "No ha colocado el nombre del Tipo Contrato " + "  \n";
            verificado = false;
        }
