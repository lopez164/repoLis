...
import aplicacionlogistica.distribucion.Threads.HiloGuardarCanalesDeVentas;
 ...
 * @author Usuario
 */
public class FCrearCanalDeVentas extends javax.swing.JInternalFrame {
...
//private FResidentes residente = (FResidentes)this.getParent();//
     ...
     */
    public FCrearCanalDeVentas() {
        initComponents();
        txtNombeCanalDeVentas.requestFocus();
    }

    public FCrearCanalDeVentas(Inicio ini) {
        initComponents();
        this.ini = ini;
    ...
    private void initComponents() {
        ...
        txtNombeCanalDeVentas = new javax.swing.JTextField();
        ...
        lblCanalDeVentas = new javax.swing.JLabel();

        setClosable(true);
        setTitle("Formulario para el ingreso de Canales de Ventas");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/turbo_64x64.png"))); // NOI18N

        jLabel1.setText("Canal de Ventas");

        txtNombeCanalDeVentas.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtNombeCanalDeVentasFocusGained(evt);
            }
        });
        txtNombeCanalDeVentas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtNombeCanalDeVentasKeyPressed(evt);
            }
        });
        ...
        tblCanales.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tblCanales.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblCanalesMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblCanales);
        if (tblCanales.getColumnModel().getColumnCount() > 0) {
            tblCanales.getColumnModel().getColumn(0).setResizable(false);
            tblCanales.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblCanales.getColumnModel().getColumn(1).setResizable(false);
            tblCanales.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblCanales.getColumnModel().getColumn(2).setResizable(false);
            tblCanales.getColumnModel().getColumn(2).setPreferredWidth(50);
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(txtNombeCanalDeVentas, javax.swing.GroupLayout.Alignment.LEADING)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addComponent(txtNombeCanalDeVentas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(1, 1, 1)
        ...
        lblCanalDeVentas.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblCanalDeVentas.setText("Id. Canal de Venta : ");
    ...
    private void tblCanalesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCanalesMouseClicked
        ...
        new Thread(new HiloFcrearCanalDeVentas(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblCanalesMouseClicked

    private void txtNombeCanalDeVentasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombeCanalDeVentasKeyPressed
...
//            }
//        }
    }//GEN-LAST:event_txtNombeCanalDeVentasKeyPressed

    private void txtNombeCanalDeVentasFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNombeCanalDeVentasFocusGained
        txtNombeCanalDeVentas.setSelectionStart(0);
        txtNombeCanalDeVentas.setSelectionEnd(txtNombeCanalDeVentas.getText().length());
    }//GEN-LAST:event_txtNombeCanalDeVentasFocusGained
 ...
 btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
    ...
    private void nuevo() {
        if (actualizar) {
            ...
            txtNombeCanalDeVentas.setEnabled(true);
            ...
            try {
                canalDeVentas = new CCanalesDeVenta(ini);
                txtNombeCanalDeVentas.setEnabled(true);
                txtNombeCanalDeVentas.requestFocus();
                chkActivo.setSelected(true);
                tblCanales.setEnabled(false);
                btnNuevo.setEnabled(false);
                jBtnNuevo.setEnabled(false);
                btnGrabar.setEnabled(true);
                jBtnGrabar.setEnabled(true);
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        ...
        if (!txtNombeCanalDeVentas.getText().isEmpty()) {
            int x = JOptionPane.showConfirmDialog(this, "Desea guardar el registro ?", "Guardar registro", 0);
            if (x == JOptionPane.OK_OPTION) {
                new Thread(new HiloFcrearCanalDeVentas(ini, this, "guardar")).start();
    ...
    public javax.swing.JLabel lblCanalDeVentas;
    public javax.swing.JTable tblCanales;
    public javax.swing.JTextField txtNombeCanalDeVentas;
 ...
 public boolean validar() {
    ...
    private boolean guardarRegistroCargo() {
        ...
        try {
            ...
            canal.setNombreCanalDeVenta(txtNombeCanalDeVentas.getText().trim());
            if (chkActivo.isSelected()) {
            ...
            if (valida) {
                ...
                fila[2] = true;
                modelo = (DefaultTableModel) tblCanales.getModel();
                modelo.addRow(fila);
            }
    ...
    private boolean actualizarRegistroCanalDeVenta() {
        boolean valida = false;
        try {
            int row = tblCanales.getSelectedRow();
            CCanalesDeVenta canal = new CCanalesDeVenta(ini);
            canal.setIdCanalDeVenta((Integer) tblCanales.getValueAt(row, 0));
            canal.setNombreCanalDeVenta(txtNombeCanalDeVentas.getText().trim());
            if (chkActivo.isSelected()) {
                canal.setActivoCanal(1);
            } else {
            ...
            if (valida) {
                tblCanales.setValueAt(canal.getNombreCanalDeVenta(), row, 1);
            }
        } catch (Exception ex) {
            Logger.getLogger(FCrearCanalDeVentas.class.getName()).log(Level.SEVERE, null, ex);
        }
