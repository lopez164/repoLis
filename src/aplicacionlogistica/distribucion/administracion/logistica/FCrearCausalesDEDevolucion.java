 ...
 * @author Usuario
 */
public class FCrearCausalesDEDevolucion extends javax.swing.JInternalFrame {
    ...
    Inicio ini;
    String mensaje;
    public CCausalesDeDevolucion causalDeDevolucion = null;
    public int indice;
...
//private FResidentes residente = (FResidentes)this.getParent();//
     ...
     */
    public FCrearCausalesDEDevolucion() {
        initComponents();
        txtNombeCausalDeDevolucion.requestFocus();
    }

    public FCrearCausalesDEDevolucion(Inicio ini) {
        initComponents();
        this.ini = ini;
        ...
        new Thread(new HiloFcrearCausalesDeDevolucion(ini, this, "listaDeCausales")).start();
    }
    ...
    private void initComponents() {
        ...
        tblCausalesDeDEvolcuion = new javax.swing.JTable();
        ...
        lblCausalDeDevolucion = new javax.swing.JLabel();
        ...
        tblCausalesDeDEvolcuion.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblCausalesDeDEvolcuion.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tblCausalesDeDEvolcuion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblCausalesDeDEvolcuionMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblCausalesDeDEvolcuion);
        if (tblCausalesDeDEvolcuion.getColumnModel().getColumnCount() > 0) {
            tblCausalesDeDEvolcuion.getColumnModel().getColumn(0).setResizable(false);
            tblCausalesDeDEvolcuion.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblCausalesDeDEvolcuion.getColumnModel().getColumn(1).setResizable(false);
            tblCausalesDeDEvolcuion.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblCausalesDeDEvolcuion.getColumnModel().getColumn(2).setResizable(false);
            tblCausalesDeDEvolcuion.getColumnModel().getColumn(2).setPreferredWidth(50);
        }
        ...
        lblCausalDeDevolucion.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblCausalDeDevolucion.setText("Id. Causal  de Devol. : ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(lblCausalDeDevolucion, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addComponent(lblCausalDeDevolucion)
                .addGap(1, 1, 1)
    ...
    private void tblCausalesDeDEvolcuionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCausalesDeDEvolcuionMouseClicked

        new Thread(new HiloFcrearCausalesDeDevolucion(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblCausalesDeDEvolcuionMouseClicked
...
//        }
 ...
 btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
       ...
       jBtnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Save.png")));
        ...
        tblCausalesDeDEvolcuion.setEnabled(true);
        causalDeDevolucion = null;
    }
    ...
    private void nuevo() {
        if (actualizar) {
            ...
            try {
                causalDeDevolucion = new CCausalesDeDevolucion(ini);
                txtNombeCausalDeDevolucion.setEnabled(true);
                txtNombeCausalDeDevolucion.requestFocus();
                chkActivo.setSelected(true);
                tblCausalesDeDEvolcuion.setEnabled(false);
                btnNuevo.setEnabled(false);
                jBtnNuevo.setEnabled(false);
                btnGrabar.setEnabled(true);
                jBtnGrabar.setEnabled(true);
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        ...
        if (!txtNombeCausalDeDevolucion.getText().isEmpty()) {
            ...
            if (x == JOptionPane.OK_OPTION) {
                new Thread(new HiloFcrearCausalesDeDevolucion(ini, this, "guardar")).start();
    ...
    private void chkActivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkActivoActionPerformed
        if (chkActivo.isSelected()) {
            chkActivo.setText("Canal activo");
        } else {
            chkActivo.setText("Canal No Activo");
        }
    ...
    public javax.swing.JLabel lblCausalDeDevolucion;
    public javax.swing.JTable tblCausalesDeDEvolcuion;
 ...
 public boolean validar() {
    ...
    private boolean guardarRegistroCargo() {
        ...
        try {
            ...
            if (valida) {
                ...
                fila[2] = true;
                modelo = (DefaultTableModel) tblCausalesDeDEvolcuion.getModel();
                modelo.addRow(fila);
            }
    ...
    private boolean actualizarRegistroCanalDeVenta() {
        boolean valida = false;
        try {
            int row = tblCausalesDeDEvolcuion.getSelectedRow();
            CCanalesDeVenta canal = new CCanalesDeVenta(ini);
            canal.setIdCanalDeVenta((Integer) tblCausalesDeDEvolcuion.getValueAt(row, 0));
            canal.setNombreCanalDeVenta(txtNombeCausalDeDevolucion.getText().trim());
            if (chkActivo.isSelected()) {
                canal.setActivoCanal(1);
            } else {
            ...
            if (valida) {
                tblCausalesDeDEvolcuion.setValueAt(canal.getNombreCanalDeVenta(), row, 1);
            }
        } catch (Exception ex) {
            Logger.getLogger(FCrearCausalesDEDevolucion.class.getName()).log(Level.SEVERE, null, ex);
        }
