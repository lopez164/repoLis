 ...
 * @author VLI_488
 */
public class FgraficoPedidosMovilizados extends javax.swing.JInternalFrame {
...
//    CAgencias agencia;
     ...
     * @param ini
     */
    public FgraficoPedidosMovilizados(Inicio ini ) {
    initComponents();
    ...
    this.ini=ini;
       ...
       lblCirculoDeProgreso.setVisible(false);
        ...
        jFechaFinal.setDate(new Date(min));
            ...
            Logger.getLogger(FgraficoPedidosMovilizados.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        rBtnCantidadPedidos = new javax.swing.JRadioButton();
        rBtnValorFactura = new javax.swing.JRadioButton();
        ...
        buttonGroup1.add(rBtnCantidadPedidos);
        rBtnCantidadPedidos.setText("Cantiddad de Pedidos");

        buttonGroup1.add(rBtnValorFactura);
        rBtnValorFactura.setText("Por Valor Facturas");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(rBtnCantidadPedidos)
                        .addGap(31, 31, 31)
                        .addComponent(rBtnValorFactura)
        ...
        pnlGrafico1.setBorder(javax.swing.BorderFactory.createBevelBorder(0));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       //pnlGrafico1=new JPanel() ;
        ...
        new Thread(new FgraficoPedidosMovilizadosHilo(this.ini, this, fechaIncial, fechaFinal)).start();
    ...
    public javax.swing.JRadioButton rBtnCantidadPedidos;
    public javax.swing.JRadioButton rBtnValorFactura;
