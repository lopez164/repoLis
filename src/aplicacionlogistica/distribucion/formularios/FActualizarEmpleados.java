...
import aplicacionlogistica.distribucion.integrador.*;
 ...
 * @author Usuario
 */
public class FActualizarEmpleados extends javax.swing.JInternalFrame {
     ...
     */
    public FActualizarEmpleados() {
        initComponents();

    }

    public FActualizarEmpleados(Inicio ini) {
        this.ini = ini;
        initComponents();
    ...
    private void initComponents() {
        ...
        getAccessibleContext().setAccessibleName("Formulario para Actualizar Conductores");
