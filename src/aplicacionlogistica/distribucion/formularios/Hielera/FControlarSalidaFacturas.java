 ...
 * @author VLI_488
 */
public class FControlarSalidaFacturas extends javax.swing.JInternalFrame {
...
//    public ArrayList<Vst_ProductosPorFacturaDescargados> listaDeProductosRechazados;
     ...
     */
    public FControlarSalidaFacturas(Inicio ini) throws Exception {
        try {
            initComponents();
             this.ini = ini;
            ...
            Logger.getLogger(FControlarSalidaFacturas.class.getName()).log(Level.SEVERE, null, ex);
        }
     ...
     */
    public FControlarSalidaFacturas(Inicio ini, JInternalFrame form, CFacturas factura) throws Exception {
    ...
    public FControlarSalidaFacturas(Inicio ini, CFacturas factura) throws Exception {
        this.factura = factura;
        try {
            initComponents();
            this.ini = ini;
     ...
     * @param factura corrresponde a la factura que se va a consultar
     */
    public FControlarSalidaFacturas(Inicio ini, FConsultarFacturasPorCliente fconsultarfacturasPorCliente, CFacturas factura) throws Exception {
        this.factura = factura;
    ...
    public FControlarSalidaFacturas(Inicio ini, JInternalFrame form, String numeroFactura) throws Exception {
