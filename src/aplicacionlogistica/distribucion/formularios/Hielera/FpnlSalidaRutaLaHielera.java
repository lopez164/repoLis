 ...
 * @author lelopez
 */
public class FpnlSalidaRutaLaHielera extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form pnlSalidaRutaLaHielera
     */
    public FpnlSalidaRutaLaHielera() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("form ppal"));
...
//                    new Thread(new JcProgressBar(brrProgreso, 100)).start();
    ...
    private String buscarmanifiesto() {
        ...
        if (manifiestoActual.getConductor() != null || manifiestoActual.getVehiculo() != null) {
            ...
            try {
                Date dt = new Date();
                dt = Inicio.getFechaSql(this.dateManifiesto);
