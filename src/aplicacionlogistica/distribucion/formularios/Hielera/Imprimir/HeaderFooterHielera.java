 ...
 * @author lopez164
 */
public class HeaderFooterHielera extends PdfPageEventHelper {
    ...
    public HeaderFooterHielera(Inicio ini, boolean dibujarLinea) {
        this.ini = ini;
...
//        }
            ...
            Logger.getLogger(HeaderFooterHielera.class.getName()).log(Level.SEVERE, null, ex);
        }

    }

    public HeaderFooterHielera(Inicio ini, boolean dibujarLinea, CManifiestosDeDistribucion manifiesto) {
        this.ini = ini;
        propiedades = ini.getPropiedades();
        this.dibujarLinea = dibujarLinea;
...
//        }
    ...
    public HeaderFooterHielera(Inicio ini, boolean dibujarLinea, CManifiestosDeDistribucion manifiesto, PdfWriter pdw, boolean conMarcaDeAgua) {
        this.ini = ini;
...
//                }
            ...
            if (manifiesto != null){
            ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_RIGHT, new Phrase("Fecha de Despacho: " + this.manifiesto.getHoraDeLiquidacion(), myfont), 550, rect.getBottom(), 0);
            
            /* Se agrega la fecha de impresión del documento al pie de página */
           
              ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_LEFT, new Phrase("Manifiesto N° : " + this.manifiesto.codificarManifiesto(), myfont), 45, rect.getBottom(), 0);
    ...
    private void poneSelloAgua() {
        try {
            ...
            //if (manifiesto.getEstadoManifiesto() == 2) {
                template.showText("CONDUCTOR SIN LIQUIDAR");
            //}
