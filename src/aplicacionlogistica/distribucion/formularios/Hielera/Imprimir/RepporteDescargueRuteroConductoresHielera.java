 ...
 * @author lopez164
 */
public class RepporteDescargueRuteroConductoresHielera {
    ...
    public RepporteDescargueRuteroConductoresHielera(Inicio ini, CManifiestosDeDistribucion manifiestoActual) throws Exception {
       ...
       // CEmpleados conductor = null; //= null;
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(RepporteDescargueRuteroConductoresHielera.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//            }
           ...
           String valor = NumberToLetterConverter.convertNumberToLetter(this.manifiestoActual.getValorTotalManifiesto());

           Paragraph prValorManifiesto = new Paragraph(new Phrase("Valor total éste manifiesto  :( " + nf.format(this.manifiestoActual.getValorTotalManifiesto()) + ") \n" + valor + "\n\n\n", myfont1));
    ...
    private void tablaEncabezadoDeInforme(Font myfont3, Font myfont1, CManifiestosDeDistribucion manifiestoActual1, Inicio ini, CUsuarios user, PdfPTable tableEncabezadoInforme) {
        ...
        mCellVacia = new PdfPCell(new Phrase(": " + nf.format(manifiestoActual.getValorTotalManifiesto()), myfont1));
