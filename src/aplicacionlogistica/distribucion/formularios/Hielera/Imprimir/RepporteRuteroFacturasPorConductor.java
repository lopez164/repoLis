 ...
 * @author lopez164
 */
public class RepporteRuteroFacturasPorConductor {
    ...
    public RepporteRuteroFacturasPorConductor(Inicio ini, CEmpleados conductor) throws Exception {

        this.conductor = conductor;
        
//        if(this.conductor.getEstadoManifiesto()==3){
//            conMarcaDeAgua=false;
//        }
        

        /*Se crea el usuario que creo el manifiesto*/
//        CUsuarios user = new CUsuarios(ini, this.conductor.getUsuarioManifiesto(), 0);
        CUsuarios usuarioQueReporta = null;
//
//        codigoManifiesto = this.conductor.codificarManifiesto();

        String cadena;
        // rutaDeArchivo = "" + (new File(".").getAbsolutePath()).replace(".", "");
        
       // Vst_empleados conductor = null; //= null;
        //Vst_empleados aux = null; //= null;
        //Vst_empleados despachado = null;
        ...
        formatoNumero.setMaximumFractionDigits(2);
         ...
         valorTotalTransportado=0.0;
             for (CFacturasPorManifiesto fxm : conductor.getListaDeFacturaPorConductor()){
                 valorTotalTransportado+=fxm.getPesoFactura();
                 fechaDistribucion=fxm.getFechaDistribucion();
             }
        ...
        try {
            ...
            rutaReporte = ini.getRutaDeApp() + "manifiestos/cond_" + this.conductor.getCedula() + "_" + fechaDistribucion + ".pdf";
            ...
            try {
                ...
                Logger.getLogger(RepporteRuteroFacturasPorConductor.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            event = new HeaderFooterHielera(ini, dibujarLinea, this.manifiesto, writer,conMarcaDeAgua);
            ...
            String val =  conductor.getCedula(); //getStringNumeroDemanifiesto(this.conductor.getNumeroManifiesto());
...
//            for (Vst_empleados obj : ini.getListaDeEmpleados()) {
//                if (obj.getCedula().equals(this.conductor.getDespachador())) {
//                    despachador = new Vst_empleados(ini);
//                    despachador = obj;
//                    break;
//                }
//
//            }
            ...
            tablaEncabezadoDeInforme(myfont3, myfont1, this.conductor, ini, usuarioQueReporta, tableEncabezadoInforme);
            ...
            tablaDatosDelInformeFacturas.setTotalWidth(new float[]{25, 54,40,40, 30, 138, 85, 63, 55});
            ...
            PdfPCell cellmanifiesto = new PdfPCell(new Phrase("Man.", myfont3));
            cellmanifiesto.setPadding(5);
            cellmanifiesto.setBorder(Rectangle.NO_BORDER);
            
             PdfPCell cellplaca = new PdfPCell(new Phrase("Placa", myfont3));
            cellplaca.setPadding(5);
            ...
            PdfPCell cellDireccion = new PdfPCell(new Phrase("Hora", myfont3));
            ...
            PdfPCell cellPesoKg = new PdfPCell(new Phrase("Peso", myfont3));
            ...
            tablaDatosDelInformeFacturas.addCell(cellplaca);
            ...
            for (CFacturasPorManifiesto obj : this.conductor.getListaDeFacturaPorConductor()) {

                if (contadorDeFacturas == 0) {
                    usuarioQueReporta = ini.getUser();
                    fechaDistribucion = obj.getFechaDistribucion();
                }
                ...
                PdfPCell celda2A;
                celda2A = new PdfPCell(new Phrase("" + obj.getNumeroManifiesto(), myfont)); 
                celda2A.setBorder(Rectangle.NO_BORDER);
                
                PdfPCell celda2B;
                celda2B = new PdfPCell(new Phrase("" + obj.getVehiculo(), myfont)); 
                celda2B.setBorder(Rectangle.NO_BORDER);
               ...
               // cadena = obj.getDireccionDeCliente();
               cadena = obj.getFechaIng();
                if (cadena.length() >= 20) {
                    cadena = cadena.substring(0, 19);
                }
                ...
                tablaDatosDelInformeFacturas.addCell(celda2A);
                tablaDatosDelInformeFacturas.addCell(celda2B);
           ...
           // this.conductor.setListaDeProductosMinuta();
           ...
           String valor = NumberToLetterConverter.convertNumberToLetter(this.conductor.getValorTotalFacturas(false));

           Paragraph prValorManifiesto = new Paragraph(new Phrase("Valor total éste manifiesto  :( " + nf.format(this.conductor.getValorTotalFacturas(false)) + ") \n" + valor + "\n\n\n", myfont1));
            ...
            //Phrase lineaDespachador = new Phrase(new Phrase("________________________________\n" + "Despacha : \n" + this.conductor.getNombreDespach + " " + this.conductor.getApellidosDespachador(), myfont1));

            Phrase lineaObservaciones = new Phrase(new Phrase("\n\n" + "OBSERVACIONES : \n",myfont6));
            Phrase Observaciones = new Phrase(new Phrase("pueba observaciones" + "\n",myfont4));
...
//            tablaDeFirmas.addCell(celdaDespachador);
            ...
            if (this.conductor.getListaDeDescuentos()!=null && this.conductor.getListaDeDescuentos().size() > 0 ) {
             ...
             /*Se valida si hay facturas con descuento
            if (this.conductor.getListaDeRecogidas()!=null && this.conductor.getListaDeRecogidas().size() > 0  ) {
    ...
    private void tablaEncabezadoDeInforme(Font myfont3, Font myfont1, CEmpleados conductor, Inicio ini, CUsuarios user, PdfPTable tableEncabezadoInforme) {
        ...
        cellPlaca.setBorder(Rectangle.NO_BORDER);
        mCellPlaca = new PdfPCell(new Phrase(": " + "Prueba placa vehiculo", myfont1));
        ...
        mCellKilometros = new PdfPCell(new Phrase(": " + "Prueba km", myfont1));
        ...
        mCellRuta = new PdfPCell(new Phrase(": " + "pueba nombre de ruta", myfont1));
        ...
        mCellNumeroManifiesto = new PdfPCell(new Phrase(": " + "prueba nuemro de manifiesto", myfont1));
        ...
        mCellCanalDeDistribucion = new PdfPCell(new Phrase(": " + "prueba nombre canal", myfont1));
        ...
        mCellVacia = new PdfPCell(new Phrase(": " + nf.format(conductor.getValorTotalFacturas(false)), myfont1));
        ...
        mCellFecha = new PdfPCell(new Phrase(": " + fechaDistribucion, myfont1));
        ...
        mCellPesoKgMfto = new PdfPCell(new Phrase("" + "prueba peso de mercancia" + " Kg.", myfont1));
        mCellPesoKgMfto.setBorder(Rectangle.NO_BORDER);
    ...
    private void tablaDescuentosPorFactura(Font myfont3, int contadorDeFacturas, Font myfont) throws DocumentException {
        ...
        for (CDescuentosPorFactura obj : this.conductor.getListaDeDescuentos()) {
        ...
        int residuo = this.conductor.getListaDeDescuentos().size() % 3;
        residuo = 3 - residuo;
...
//        }
//        /*Asignción de valores  las celdas */
//        for (CRecogidasPorFactura obj : this.conductor.getListaDeRecogidas()) {
//            
//            /*Asigna el numero del consecutivo de la factura*/
//            celdaNUmeroConsecutivo = new PdfPCell(new Phrase("" + (contadorDeFacturas + 1) + ".", myfont));
//            celdaNUmeroConsecutivo.setBorder(Rectangle.NO_BORDER);
...
//        /*Calcula si en la fila quedan celdas vacias y los acomoda en el informe
//        con un colspan uniendo las celdas desocupadas*/
//        int residuo = this.conductor.getListaDeRecogidas().size() % 3;
//        residuo = 3 - residuo;
//        PdfPCell celda4 = new PdfPCell(new Phrase(""));
//        celda4.setBorder(Rectangle.NO_BORDER);
//        celda4.setColspan(residuo * 4);
...
//        
//        /*Asignción de valores  las celdas */
//        for (CProductosMinuta obj : this.conductor.getListaDeProductosMinuta()) {
//            
//            /*Asigna el numero del consecutivo de la factura*/
