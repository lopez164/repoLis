...
import aplicacionlogistica.distribucion.formularios.reportes.threads.HiloFReporteAlertasSalidaDeProductos;
 ...
 * @author VLI_488
 */
public class FReporteAlertasSalidaDeProductos extends javax.swing.JInternalFrame {
     ...
     * @param ini
     */
    public FReporteAlertasSalidaDeProductos(Inicio ini) {
        initComponents();
           this.ini = ini;
        ...
        try {
            ...
            Logger.getLogger(FReporteAlertasSalidaDeProductos.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Formulario Reporte Alertas en Salida de Productos");
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("Consulta de Alertas en Salida de Productos"));
        ...
        tablaRegistros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "numeroManifiesto", "Conductor", "Factura(s)", "Observacion", "Fecha", "usuario"
            }
        ) {
        ...
        if (tablaRegistros.getColumnModel().getColumnCount() > 0) {
            ...
            tablaRegistros.getColumnModel().getColumn(3).setPreferredWidth(140);
            tablaRegistros.getColumnModel().getColumn(4).setPreferredWidth(400);
            tablaRegistros.getColumnModel().getColumn(5).setPreferredWidth(150);
            tablaRegistros.getColumnModel().getColumn(6).setPreferredWidth(80);
        }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
       ...
       // String ss = "" + this.jFechaFinal.getDate();
        ...
        new Thread(new HiloFReporteAlertasSalidaDeProductos(this)).start();
...
int i = tablaRegistros.getSelectedRow();
String value = tablaRegistros.getValueAt(i, 4). toString().replace(",", ",\n");
...
JOptionPane.showMessageDialog(this, value);
    ...
    public void llenarTablaListaDeFacturasSinMovimiento() throws Exception {
        ...
        for (Vst_FacturasPorManifiesto obj : listaDeFacturasSinMovimiento) {
            ...
            tablaRegistros.setValueAt(obj.getBarrio(), filaTabla2, 5); // nombre del conductor
