...
import aplicacionlogistica.distribucion.formularios.reportes.threads.HiloFReporteDePorteria;
 ...
 * @author VLI_488
 */
public class FReporteDePorteria extends javax.swing.JInternalFrame {
    ...
    public ArrayList<CFacturasPorManifiesto> listaDeFacturasPorManifiesto = null;
     ...
     * @param ini
     */
    public FReporteDePorteria(Inicio ini) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(FReporteDePorteria.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Formulario Reporte movimientos en Porteria");
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("Reporte de pedidos Gestionados en Porteria"));
        ...
        tablaRegistros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "numeroFactura", "numeroManifiesto", "Conductor", "fechaVenta", "nombreDeCliente", "direccionDeCliente", "Estado", "H.Pick", "H. Desp", "operario", "minutos"
            }
        ) {
        ...
        if (tablaRegistros.getColumnModel().getColumnCount() > 0) {
            ...
            tablaRegistros.getColumnModel().getColumn(8).setPreferredWidth(160);
            tablaRegistros.getColumnModel().getColumn(9).setPreferredWidth(160);
            tablaRegistros.getColumnModel().getColumn(10).setPreferredWidth(115);
            tablaRegistros.getColumnModel().getColumn(11).setPreferredWidth(70);
        }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        new Thread(new HiloFReporteDePorteria(this, true)).start();
    ...
    public void llenarTablaListaDeFacturas() throws Exception {
        ...
        System.out.println(new Date() + " acá se calcula la cantidad de rtegistros de la lista =" + listaDeFacturasPorManifiesto.size());
        ...
        for (CFacturasPorManifiesto obj : listaDeFacturasPorManifiesto) {
            ...
            if (obj.getDespachado() == 1) {
                tablaRegistros.setValueAt("PEDIDO VERIFICADO", filaTabla2, 7); // nombre del conductor
            } else {
                tablaRegistros.setValueAt("SIN VERIFICAR", filaTabla2, 7); // nombre del conductor
            }
            ...
            if (("" + obj.getFechaIng()).length() >= 7) {
                tablaRegistros.setValueAt(("" + obj.getFechaIng()).substring(11), filaTabla2, 8); // nombre del conductor
            } else {
                tablaRegistros.setValueAt("" , filaTabla2, 8); // nombre del conductor
            }
            if (("" + obj.getFechaDespachado()).length() >= 7) {
                tablaRegistros.setValueAt(("" + obj.getFechaDespachado()).substring(11), filaTabla2, 9); // nombre del conductor
            } else {
                tablaRegistros.setValueAt("", filaTabla2, 9); // nombre del conductor
            }

            tablaRegistros.setValueAt(obj.getUsuariodespachador(), filaTabla2, 10); // nombre del conductor
            tablaRegistros.setValueAt(obj.getMinutos(), filaTabla2, 11); // nombre del conductor
