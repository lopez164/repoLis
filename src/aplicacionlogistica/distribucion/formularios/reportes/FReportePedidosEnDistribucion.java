 ...
 * @author VLI_488
 */
public class FReportePedidosEnDistribucion extends javax.swing.JInternalFrame {
     ...
     * @param ini
     */
    public FReportePedidosEnDistribucion(Inicio ini) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tablaRegistros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "numeroManifiesto", "numeroFactura", "fechaDistribucion", "fechaDeVenta", "vehiculo", "tipoContrato", "conductor", "nombreConductor", "nombreDeRuta", "vendedor", "salidasDistribucion", "fechareal"
            }
        ) {
        ...
        if (tablaRegistros.getColumnModel().getColumnCount() > 0) {
            ...
            tablaRegistros.getColumnModel().getColumn(1).setMinWidth(40);
            ...
            tablaRegistros.getColumnModel().getColumn(6).setMinWidth(20);
            tablaRegistros.getColumnModel().getColumn(7).setMinWidth(30);
            tablaRegistros.getColumnModel().getColumn(8).setMinWidth(70);
            tablaRegistros.getColumnModel().getColumn(9).setMinWidth(70);
            tablaRegistros.getColumnModel().getColumn(10).setMinWidth(50);
            tablaRegistros.getColumnModel().getColumn(11).setMinWidth(30);
        }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        new Thread(new HiloReportePedidosEnDistribucion(this)).start();
    ...
    private void btnExportarExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarExcelActionPerformed
        btnExportarExcel.setEnabled(false);
        new Thread(new HiloReportePedidosEnDistribucion(this, false)).start();
