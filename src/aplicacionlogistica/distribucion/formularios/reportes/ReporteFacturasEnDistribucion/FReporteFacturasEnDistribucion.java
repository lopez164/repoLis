 ...
 */
package aplicacionlogistica.distribucion.formularios.reportes.ReporteFacturasEnDistribucion;
 ...
 * @author VLI_488
 */
public class FReporteFacturasEnDistribucion extends javax.swing.JInternalFrame {
     ...
     * @param ini
     */
    public FReporteFacturasEnDistribucion(Inicio ini) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(FReporteFacturasEnDistribucion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Thread(new HiloReporteFacturasEnDistribucion(this)).start();
