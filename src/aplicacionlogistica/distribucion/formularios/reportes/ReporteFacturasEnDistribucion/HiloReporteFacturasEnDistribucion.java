 ...
 * @author Usuario
 */
public class HiloReporteFacturasEnDistribucion implements Runnable {

   
   
    Inicio ini;
    FReporteFacturasEnDistribucion form;
     ...
     * @param ini
     */
    public HiloReporteFacturasEnDistribucion(FReporteFacturasEnDistribucion form) {
        this.form=form;       
        this.ini = form.ini;
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(HiloReporteFacturasEnDistribucion.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
