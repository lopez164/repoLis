 ...
 * @author VLI_488
 */
public class FReporteManifiestosEnDistribucion extends javax.swing.JInternalFrame {
     ...
     * @param ini
     */
    public FReporteManifiestosEnDistribucion(Inicio ini) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(FReporteManifiestosEnDistribucion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Consulta Manifiestos saliendo a Distribucion");
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("Consulta Manifiestos en Distribucion por Fecha"));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(341, 374, Short.MAX_VALUE))
            .addGroup(layout.createSequentialGroup()
                .addComponent(pnlGrafico1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnEjecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEjecutarActionPerformed
        ...
        new Thread(new HiloReporteManifiestosEnDistribucion(this)).start();
    ...
    public void llenarTablabitacora() throws Exception {
        ...
        for (CManifiestosDeDistribucion obj : listaDeRegistros) {
            ...
            tablaRegistros.setValueAt(obj.getConductor(), filaTabla2, a++); // nombre del conductor
