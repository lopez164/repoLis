 ...
 */
package aplicacionlogistica.distribucion.formularios.reportes.ReporteManifiestosEnDistribucion;
 ...
 * @author Usuario
 */
public class HiloReporteManifiestosEnDistribucion implements Runnable {

   
   
    Inicio ini;
    FReporteManifiestosEnDistribucion form;
     ...
     * @param ini
     */
    public HiloReporteManifiestosEnDistribucion(FReporteManifiestosEnDistribucion form) {
        this.form=form;       
        this.ini = form.ini;
    ...
    public void run() {
            ...
            case 2:
        {
            try {
                ...
                Logger.getLogger(HiloReporteManifiestosEnDistribucion.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
                break;
        }
    ...
    private void traerDatos() throws HeadlessException {
        ...
        try {
            ...
            ArrayList<CManifiestosDeDistribucion> listaDeManifestosEnDistribucion = null;
            ...
            listaDeManifestosEnDistribucion = new ArrayList();
            
            if (con != null) {
                st = con.createStatement();
                rst = st.executeQuery(ini.arrListadoDeManifiestosEnDistribucion(fecha));
                ...
                while (rst.next()) {
                    ...
                    vista.setConductor(rst.getString("nombreConductor"));
                    ...
                    listaDeManifestosEnDistribucion.add(vista);
                ...
                st.close();
                con.close();
                ini.setListaDeManifiestosEnDistribucion(listaDeManifestosEnDistribucion);
                form.listaDeRegistros=listaDeManifestosEnDistribucion;
                Thread.sleep(1);
