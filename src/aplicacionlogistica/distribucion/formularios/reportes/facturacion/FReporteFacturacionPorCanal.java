 ...
 * @author VLI_488
 */
public class FReporteFacturacionPorCanal extends javax.swing.JInternalFrame {
     ...
     * @param ini
     */
    public FReporteFacturacionPorCanal(Inicio ini) {
        initComponents();
    ...
    private void cuadrarFechaJDateChooser() {
        ...
        try {
            ...
            Logger.getLogger(FReporteFacturacionPorCanal.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Formulario de consulta Facturacion por periodo y canal de Venta");
        ...
        tablaRegistros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "fecha", "Poblaciones", "Mayoristas", "Minimercados", "TAT", "Total Movilizado"
            }
        ) {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        new Thread(new FReporteFacturacionPorCanalHilo(this)).start();
    ...
    private void btnExportarExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarExcelActionPerformed
        btnExportarExcel.setEnabled(false);
        new Thread(new FReporteFacturacionPorCanalHilo(this, false)).start();
    ...
    public void llenarTablabitacora() throws Exception {
        ...
        for (objReporteFacturacionPorCanal obj : listaDeRegistros) {
            ...
            tablaRegistros.setValueAt(obj.getFecha(), filaTabla2, 1);  // item
            tablaRegistros.setValueAt(nf.format(obj.getPoblaciones()), filaTabla2, 2); // numero de manifiesto
            tablaRegistros.setValueAt(nf.format(obj.getMayoristas()), filaTabla2, 3); // fecha de distribucion
            tablaRegistros.setValueAt(nf.format(obj.getMinimercados()), filaTabla2, 4); // placa del vehiculo
            tablaRegistros.setValueAt(nf.format(obj.getTat()), filaTabla2, 5); // nombre del conductor
            tablaRegistros.setValueAt(nf.format(obj.getTotal()), filaTabla2, 6); // nombre del conductor
