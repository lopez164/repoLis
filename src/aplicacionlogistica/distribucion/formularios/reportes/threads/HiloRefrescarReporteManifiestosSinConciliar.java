 ...
 * @author Usuario
 */
public class HiloRefrescarReporteManifiestosSinConciliar implements Runnable {

   
   
    Inicio ini;
    FReporteManifiestosConcilidos form;
     ...
     * @param ini
     */
    public HiloRefrescarReporteManifiestosSinConciliar(FReporteManifiestosConcilidos form) {
        this.form=form;       
        this.ini = form.ini;
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(HiloRefrescarReporteManifiestosSinConciliar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
