 ...
 * @author lopez164
 */
public class RepporteRuteroConductoresProvisional {
    ...
    public RepporteRuteroConductoresProvisional(Inicio ini, CManifiestosDeDistribucion manifiestoActual) {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(RepporteRuteroConductoresProvisional.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//            }
            ...
            PdfPCell cellFactura = new PdfPCell(new Phrase("N° Factura", myfont3));
            ...
            for (CFacturasPorManifiesto obj : this.manifiestoActual.getListaFacturasPorManifiesto()) {
                ...
                // Valor de la factura             
                PdfPCell celda5 = new PdfPCell(new Phrase("" + nf.format(obj.getValorTotalFactura()), myfont));
