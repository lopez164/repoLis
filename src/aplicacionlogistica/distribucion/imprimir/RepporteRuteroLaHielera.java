...
//import aplicacionlogistica.distribucion.objetos.CManifiestosDeDistribucion_xxx;
 ...
 * @author lopez164
 */
public class RepporteRuteroLaHielera {
    ...
    // public ReporteFacturasEnDistribucion(Inicio ini, ArrayList<CFacturasPorManifiesto> arrFactPorMfto, CManifiestosDeDistribucion_xxx manifiesto, double valoraRecaudar, String codigoManifiesto) {
    public RepporteRuteroLaHielera(Inicio ini, CManifiestosDeDistribucion manifiestoActual) throws Exception {
       ...
       // CEmpleados conductor = null; //= null;
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(RepporteRuteroLaHielera.class.getName()).log(Level.SEVERE, null, ex);
            }
