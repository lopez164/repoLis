 ...
 */
public class PieChart2DFrameDemo  {
 ...
 private static boolean isApplet = true;
  ...
  public void init() {
    ...
    object2DProps.setObjectTitleText ("LOC per Class"); // Título del Gráfico
    ...
    LegendProperties legendProps = new LegendProperties(); // etiquetas de las categorias
    String[] legendLabels =
