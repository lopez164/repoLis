 ...
 */
package mtto.ingresoDeRegistros.objetos;
 ...
 * @author lelopez
 */
public class ItemsFacturaLogistica {
    ...
    public int getIditemsPorFactura() {
        return iditemsPorFactura;
    }

    public void setIditemsPorFactura(int iditemsPorFactura) {
        this.iditemsPorFactura = iditemsPorFactura;
    }
    ...
    public String getIdCuentaPrincipal() {
        return idCuentaPrincipal;
    }

    public void setIdCuentaPrincipal(String idCuentaPrincipal) {
    ...
    public ItemsFacturaLogistica(Inicio ini) {
        this.ini = ini;
    }
