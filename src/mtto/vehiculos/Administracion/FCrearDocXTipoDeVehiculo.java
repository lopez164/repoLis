 ...
 * @author Usuario
 */
public class FCrearDocXTipoDeVehiculo extends javax.swing.JInternalFrame {
    ...
    String mensaje;
    Inicio ini;
    public CTiposDeVehiculos tipoDeVehiculo;
    public int indice;
...
//private FResidentes residente = (FResidentes)this.getParent();//
     ...
     */
    public FCrearDocXTipoDeVehiculo() {
        initComponents();
        
       
    }

    public FCrearDocXTipoDeVehiculo(Inicio ini) {
        ...
        manager.addKeyEventDispatcher(new KeyEventDispatcher() {
          ...
          new Thread(new HiloFcreaDocXTipoDeVehiculo(ini, this, "cargarFormulario")).start();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Formulario para Asignar Tipo de Documentos");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/turbo_64x64.png"))); // NOI18N

        label1.setText("Nombre Tipo de Vehiculo");
        ...
        tblLineasVehiculos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id Documento", "Nombre Tipo de  Vehiculo", "Asignado"
            }
        ) {
        ...
        if (tblLineasVehiculos.getColumnModel().getColumnCount() > 0) {
            ...
            tblLineasVehiculos.getColumnModel().getColumn(2).setPreferredWidth(80);
        }
        ...
        cbxTipoDeVehiculo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cbxTipoDeVehiculo.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cbxTipoDeVehiculoItemStateChanged(evt);
            }
        });
        cbxTipoDeVehiculo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cbxTipoDeVehiculoMouseClicked(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(chkActivo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                        .addComponent(cbxTipoDeVehiculo, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
    ...
    public void grabar() throws HeadlessException {
            ...
            if (x == 0) {
                ...
                new Thread(new HiloFcreaDocXTipoDeVehiculo(ini, this, "guardar")).start();
    ...
    private void cbxTipoDeVehiculoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbxTipoDeVehiculoItemStateChanged
     if(iniciado){
       indice=cbxTipoDeVehiculo.getSelectedIndex();
       for(CTiposDeVehiculos obj : ini.getListaDeTiposDeVehiculos()){
           if(cbxTipoDeVehiculo.getSelectedItem().toString().equals(obj.getNombreTipoDeVehiculo())){
               tipoDeVehiculo = obj;
           }
       }
      
      new Thread(new HiloFcreaDocXTipoDeVehiculo(ini, this, "llenarJtable")).start(); 
    
     }
      
    }//GEN-LAST:event_cbxTipoDeVehiculoItemStateChanged

    private void cbxTipoDeVehiculoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cbxTipoDeVehiculoMouseClicked
     
    }//GEN-LAST:event_cbxTipoDeVehiculoMouseClicked
    ...
    public javax.swing.JComboBox<String> cbxTipoDeVehiculo;
       ...
       if (modelo.getRowCount() > 0) {
            ...
            for (int i = a; i >= 0; i--) {
                try {
                    ...
                    Logger.getLogger(FCrearDocXTipoDeVehiculo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
