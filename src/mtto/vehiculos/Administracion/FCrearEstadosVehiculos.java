 ...
 * @author Usuario
 */
public class FCrearEstadosVehiculos  extends javax.swing.JInternalFrame {
...
String mensaje;
Inicio ini;
CTiposEstadosVehiculos estadosVehiculos;
...
//private FResidentes residente = (FResidentes)this.getParent();//
     ...
     */
    public FCrearEstadosVehiculos() {
       initComponents();
       txtEstadoVehiculo.requestFocus();
    }
    
    
    
 public FCrearEstadosVehiculos(Inicio  ini) {
        initComponents();
        this.ini=ini;
       // this.user=ini.getUser();
        ...
        new Thread(new HiloFcrearEstadosVehiculos(ini, this, "listaDeEstadosVehiculos")).start();
 }
    ...
    private void initComponents() {
        ...
        lblEstadosVehiculos = new javax.swing.JLabel();
        ...
        setClosable(true);
        setTitle("Formulario para el ingreso de Tipos Vehiculo");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/turbo_64x64.png"))); // NOI18N

        label1.setText("nombre Estado de Vehiculo");

        txtEstadoVehiculo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtEstadoVehiculoFocusGained(evt);
            }
        });
        txtEstadoVehiculo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtEstadoVehiculoKeyPressed(evt);
            }
        });
        ...
        tblEstadosVehiculos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nombre Estado Vehiculo", "Activo"
            }
        ) {
        ...
        chkActivo.setText("Tipo Estado Activo");
        ...
        lblEstadosVehiculos.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblEstadosVehiculos.setText("Id. Estado Vehiculo : ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(label1)
                    .addComponent(lblEstadosVehiculos)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(txtEstadoVehiculo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 449, Short.MAX_VALUE)))
    ...
    private void tblEstadosVehiculosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEstadosVehiculosMouseClicked
        ...
        new Thread(new HiloFcrearEstadosVehiculos(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblEstadosVehiculosMouseClicked

    private void txtEstadoVehiculoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEstadoVehiculoKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
           btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
        }
    }//GEN-LAST:event_txtEstadoVehiculoKeyPressed

    private void txtEstadoVehiculoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtEstadoVehiculoFocusGained
        txtEstadoVehiculo.setSelectionStart(0);
        txtEstadoVehiculo.setSelectionEnd(txtEstadoVehiculo.getText().length());
    }//GEN-LAST:event_txtEstadoVehiculoFocusGained
    ...
    public void cancelar() {
        actualizar=false;
        txtEstadoVehiculo.setText("");
        chkActivo.setEnabled(false);
        chkActivo.setSelected(false);
        lblEstadosVehiculos.setVisible(false);
 btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
        jBtnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Create.png"))); // NOI18N
        btnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/grabar.png"))); // NOI18N
    ...
    public void nuevo() {
        if (actualizar) {
            ...
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
            txtEstadoVehiculo.setEnabled(true);
    ...
    public void grabar() throws HeadlessException {
        if (!txtEstadoVehiculo.getText().isEmpty()) {
            int x = JOptionPane.showConfirmDialog(this, "Desea guardar el registro ?", "Guardar registro", 0);
            if (x == 0) {
                  new Thread(new HiloFcrearEstadosVehiculos(ini, this, "guardar")).start();
            }
    ...
    private void chkActivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkActivoActionPerformed
        if(chkActivo.isSelected()){
            chkActivo.setText("Estado Vehiculo activo");
        }else{
             chkActivo.setText("Estado Vehiculo No Activo");
        }
    ...
    public javax.swing.JLabel lblEstadosVehiculos;
 ...
 public boolean validar() {
        ...
        mensaje = "";
        if (txtEstadoVehiculo.getText().isEmpty()) {
            mensaje += "No ha colocado el nombre de Estado vehiculo " + "  \n";
            verificado = false;
        }
