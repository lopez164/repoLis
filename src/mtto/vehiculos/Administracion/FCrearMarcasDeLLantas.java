 ...
 * @author Usuario
 */
public class FCrearMarcasDeLLantas  extends javax.swing.JInternalFrame {
...
String mensaje;
Inicio ini;
public CMarcasDeLLantas marcaDeLLanta;
...
//private FResidentes residente = (FResidentes)this.getParent();//
     ...
     */
    public FCrearMarcasDeLLantas() {
       initComponents();
       txtMarcaDeLlantas.requestFocus();
    }
    
    
    
 public FCrearMarcasDeLLantas(Inicio  ini) {
        initComponents();
        this.setTitle("Formulario para la gestion de Marca De Llantas");
        lblIdMarca.setText("Id. Marca De Llanta : ");
        chkActivo.setText("Marca De Llanta Activo");
        this.ini=ini;
       // this.user=ini.getUser();
                    ...
                    if (e.getSource() instanceof JComponent
                        ...
                        if (e.getKeyChar() >= 'a' && e.getKeyChar() <= 'z') {
                            if (e.getSource() instanceof JComponent
                                ...
                                //como vamos a convertir todo a mayúsculas, entonces solo checamos si los cacteres son 
                                //minusculas                          
        ...
        txtMarcaDeLlantas.setEnabled(false);
        new Thread(new HiloFcrearMarcasDeLLantas(ini, this, "listaDeMarcasDeLlantas")).start();
 }
    ...
    private void initComponents() {
        ...
        txtMarcaDeLlantas = new javax.swing.JTextField();
        jScrollPane3 = new javax.swing.JScrollPane();
        tblMarcaDeLLantas = new javax.swing.JTable();
        ...
        txtMarcaDeLlantas.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtMarcaDeLlantasFocusGained(evt);
            }
        });
        txtMarcaDeLlantas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtMarcaDeLlantasKeyPressed(evt);
            }
        });

        tblMarcaDeLLantas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblMarcaDeLLantas.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tblMarcaDeLLantas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblMarcaDeLLantasMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblMarcaDeLLantas);
        if (tblMarcaDeLLantas.getColumnModel().getColumnCount() > 0) {
            tblMarcaDeLLantas.getColumnModel().getColumn(0).setResizable(false);
            tblMarcaDeLLantas.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblMarcaDeLLantas.getColumnModel().getColumn(1).setResizable(false);
            tblMarcaDeLLantas.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblMarcaDeLLantas.getColumnModel().getColumn(2).setResizable(false);
            tblMarcaDeLLantas.getColumnModel().getColumn(2).setPreferredWidth(50);
        }
        ...
        lblIdMarca.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblIdMarca.setText(" ");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(lblNombreMarca, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addComponent(txtMarcaDeLlantas, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 449, Short.MAX_VALUE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addComponent(txtMarcaDeLlantas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tblMarcaDeLLantasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMarcaDeLLantasMouseClicked
        // TODO add your handling code here:

        new Thread(new HiloFcrearMarcasDeLLantas(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblMarcaDeLLantasMouseClicked

    private void txtMarcaDeLlantasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMarcaDeLlantasKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
           btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
        }
    }//GEN-LAST:event_txtMarcaDeLlantasKeyPressed

    private void txtMarcaDeLlantasFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtMarcaDeLlantasFocusGained
        txtMarcaDeLlantas.setSelectionStart(0);
        txtMarcaDeLlantas.setSelectionEnd(txtMarcaDeLlantas.getText().length());
    }//GEN-LAST:event_txtMarcaDeLlantasFocusGained
...
btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
       ...
       jBtnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Save.png")));
        ...
        tblMarcaDeLLantas.setEnabled(true);
    }
    ...
    public void nuevo() {
        if (actualizar) {
            ...
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
            txtMarcaDeLlantas.setEnabled(true);
            ...
            txtMarcaDeLlantas.requestFocus();
            chkActivo.setSelected(true);
            tblMarcaDeLLantas.setEnabled(false);
            btnNuevo.setEnabled(false);
            jBtnNuevo.setEnabled(false);
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
    ...
    public void grabar() throws HeadlessException {
        if (!txtMarcaDeLlantas.getText().isEmpty()) {
            int x = JOptionPane.showConfirmDialog(this, "Desea guardar el registro ?", "Guardar registro", 0);
            if (x == 0) {
                  new Thread(new HiloFcrearMarcasDeLLantas(ini, this, "guardar")).start();
            }
    ...
    private void chkActivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkActivoActionPerformed
        if(chkActivo.isSelected()){
            chkActivo.setText("Marca De Llanta activo");
             ...
             chkActivo.setText("Marca De Llanta No Activo");
        }
    ...
    public javax.swing.JLabel lblIdMarca;
    private javax.swing.JLabel lblNombreMarca;
    public javax.swing.JTable tblMarcaDeLLantas;
    public javax.swing.JTextField txtMarcaDeLlantas;
    // End of variables declaration//GEN-END:variables
 public boolean validar() {
        boolean verificado = true;
        mensaje = "";
        if (txtMarcaDeLlantas.getText().isEmpty()) {
            mensaje += "No ha colocado el nombre del Marca De Llanta " + "  \n";
            verificado = false;
        }
