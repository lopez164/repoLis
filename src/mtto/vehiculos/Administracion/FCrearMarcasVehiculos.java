 ...
 * @author Usuario
 */
public class FCrearMarcasVehiculos extends javax.swing.JInternalFrame {
...
//private FResidentes residente = (FResidentes)this.getParent();//
     ...
     */
    public FCrearMarcasVehiculos() {
        initComponents();
        txtMarcaVehiculo.requestFocus();
    }

    public FCrearMarcasVehiculos(Inicio ini) {
        initComponents();
        this.ini = ini;
        this.user = ini.getUser();
        this.setResizable(false);
        
        this.setTitle("Formulario para la gestion de Marcas de Vehculos");
        lblIdMarcaVeh.setText("Id. Marca Vehiculo : ");
        chkActivo.setText("Marca Vehiculo Activo");
        ...
        new Thread(new HiloFcrearMarcasDeVehiculo(ini, this, "listaDeMarcasVehiculos")).start();
    }
    ...
    private void initComponents() {
        ...
        tblMarcasVehiculos = new javax.swing.JTable();
        chkActivo = new javax.swing.JCheckBox();
        lblIdMarcaVeh = new javax.swing.JLabel();
        ...
        txtMarcaVehiculo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtMarcaVehiculoFocusGained(evt);
            }
        });
        txtMarcaVehiculo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtMarcaVehiculoKeyPressed(evt);
            }
        });

        tblMarcasVehiculos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblMarcasVehiculos.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tblMarcasVehiculos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblMarcasVehiculosMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblMarcasVehiculos);
        if (tblMarcasVehiculos.getColumnModel().getColumnCount() > 0) {
            tblMarcasVehiculos.getColumnModel().getColumn(0).setResizable(false);
            tblMarcasVehiculos.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblMarcasVehiculos.getColumnModel().getColumn(1).setResizable(false);
            tblMarcasVehiculos.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblMarcasVehiculos.getColumnModel().getColumn(2).setResizable(false);
            tblMarcasVehiculos.getColumnModel().getColumn(2).setPreferredWidth(50);
        }

        chkActivo.setSelected(true);
        chkActivo.setText("Marca Activa");
        ...
        lblIdMarcaVeh.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblIdMarcaVeh.setText("Id. Marca vehiculo : ");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(label1)
                            .addComponent(lblIdMarcaVeh)
                            .addComponent(txtMarcaVehiculo, javax.swing.GroupLayout.PREFERRED_SIZE, 449, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(chkActivo, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void tblMarcasVehiculosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMarcasVehiculosMouseClicked
        // TODO add your handling code here:

 new Thread(new HiloFcrearMarcasDeVehiculo(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblMarcasVehiculosMouseClicked

    private void txtMarcaVehiculoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMarcaVehiculoKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
        }
    }//GEN-LAST:event_txtMarcaVehiculoKeyPressed

    private void txtMarcaVehiculoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtMarcaVehiculoFocusGained
        txtMarcaVehiculo.setSelectionStart(0);
        txtMarcaVehiculo.setSelectionEnd(txtMarcaVehiculo.getText().length());
    }//GEN-LAST:event_txtMarcaVehiculoFocusGained
    ...
    public void cancelar() {
        ...
        lblIdMarcaVeh.setVisible(false);
btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
        jBtnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Create.png"))); // NOI18N
        btnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/grabar.png"))); // NOI18N
       jBtnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Save.png")));
        ...
        tblMarcasVehiculos.setEnabled(true);
    }
    ...
    public void nuevo() {
        if (actualizar) {
            ...
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
            txtMarcaVehiculo.setEnabled(true);
            ...
            chkActivo.setSelected(true);
            tblMarcasVehiculos.setEnabled(false);
            btnNuevo.setEnabled(false);
            jBtnNuevo.setEnabled(false);
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
    ...
    public void grabar() throws HeadlessException {
        if (!txtMarcaVehiculo.getText().isEmpty()) {
            ...
            if (x == 0) {
                  new Thread(new HiloFcrearMarcasDeVehiculo(ini, this, "guardar")).start();
            }
    ...
    public javax.swing.JLabel lblIdMarcaVeh;
    public javax.swing.JTable tblMarcasVehiculos;
 ...
 public boolean validar() {
    ...
    public boolean guardarRegistroMarcaDeVehiculo() {
        boolean valida = false;
        try {

            CMarcasDeVehiculos marca = new CMarcasDeVehiculos(ini);
            marca.setNombreMarcaDeVehiculos(txtMarcaVehiculo.getText().trim());
            if (chkActivo.isSelected()) {
            ...
            Logger.getLogger(FCrearMarcasVehiculos.class.getName()).log(Level.SEVERE, null, ex);
        }
        return valida;
    }

    public boolean actualizarRegistroMarcasDeVehiculo() {
        boolean valida = false;
        try {
            int row = tblMarcasVehiculos.getSelectedRow();
            lblIdMarcaVeh.setText("Id. Marca de Vehiculo :  " + String.valueOf(tblMarcasVehiculos.getValueAt(row, 0)));
            CMarcasDeVehiculos marcaVehiculo = new CMarcasDeVehiculos(ini);
            marcaVehiculo.setIdMarcaDeVehiculos((Integer) tblMarcasVehiculos.getValueAt(row, 0));
            marcaVehiculo.setNombreMarcaDeVehiculos(txtMarcaVehiculo.getText().trim());
            if (chkActivo.isSelected()) {
            ...
            if (valida) {
                ...
                lblIdMarcaVeh.setVisible(true);
                lblIdMarcaVeh.setText("Id. Marca de Vehiculo :  " + marcaVehiculo.getIdMarcaDeVehiculos());
                btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
                btnNuevo.setEnabled(true);
                jBtnNuevo.setEnabled(true);
                btnGrabar.setEnabled(false);
    ...
    public void llenarjTable() throws Exception {
        DefaultTableModel modelo = (DefaultTableModel) tblMarcasVehiculos.getModel();
        ...
        DefaultTableModel modelo2 = (DefaultTableModel) tblMarcasVehiculos.getModel();

        for (CMarcasDeVehiculos obj : ini.getListaDeMarcasDeVehiculos()) {
            int filaTabla2 = tblMarcasVehiculos.getRowCount();
            modelo2.addRow(new Object[tblMarcasVehiculos.getRowCount()]);
            tblMarcasVehiculos.setValueAt(obj.getIdMarcaDeVehiculos(), filaTabla2, 0);  // item
            tblMarcasVehiculos.setValueAt(obj.getNombreMarcaDeVehiculos(), filaTabla2, 1); // numero de factura
            if (obj.getActivoMarcaDeVehiculos() == 1) {
                tblMarcasVehiculos.setValueAt(true, filaTabla2, 2); //
            } else {
                tblMarcasVehiculos.setValueAt(false, filaTabla2, 2); //
            }
