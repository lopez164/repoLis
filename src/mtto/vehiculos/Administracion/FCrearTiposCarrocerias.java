 ...
 * @author Usuario
 */
public class FCrearTiposCarrocerias extends javax.swing.JInternalFrame {
    ...
    String mensaje;
    Inicio ini;
    CTiposDeCarrocerias tiposCarrocerias;
    public int indice=0;
...
//private FResidentes residente = (FResidentes)this.getParent();//
     ...
     */
    public FCrearTiposCarrocerias() {
        initComponents();
        txtTiposCarrocerias.requestFocus();
    }

    public FCrearTiposCarrocerias(Inicio ini) {
        initComponents();
        this.ini = ini;
        this.user = ini.getUser();
        this.setResizable(false);

        this.setTitle("Formulario para la gestion de Tipos de Carroceria");
        lblidTipoCarroceria.setText("Id. Tipo de Carroceria : ");
        chkActivo.setText("Tipo de Carroceria Activo");
        ...
        txtTiposCarrocerias.setEnabled(false);
        new Thread(new HiloFcrearTiposDeCarroceria(ini, this, "listaDeTiposDeCarroceria")).start();
    }
    ...
    private void initComponents() {
        ...
        txtTiposCarrocerias = new javax.swing.JTextField();
        jScrollPane3 = new javax.swing.JScrollPane();
        tblTipoDeCarroceria = new javax.swing.JTable();
        chkActivo = new javax.swing.JCheckBox();
        lblidTipoCarroceria = new javax.swing.JLabel();
        ...
        setClosable(true);
        setTitle("Formulario para el ingreso de Tipos de Carrocerias");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/turbo_64x64.png"))); // NOI18N

        label1.setText("nombre de Tipo de Carroceria");

        txtTiposCarrocerias.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtTiposCarroceriasFocusGained(evt);
            }
        });
        txtTiposCarrocerias.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtTiposCarroceriasKeyPressed(evt);
            }
        });

        tblTipoDeCarroceria.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "id", "Nombre Carroceria", "Activo"
            }
        ) {
        ...
        tblTipoDeCarroceria.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tblTipoDeCarroceria.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblTipoDeCarroceriaMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblTipoDeCarroceria);
        if (tblTipoDeCarroceria.getColumnModel().getColumnCount() > 0) {
            tblTipoDeCarroceria.getColumnModel().getColumn(0).setResizable(false);
            tblTipoDeCarroceria.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblTipoDeCarroceria.getColumnModel().getColumn(1).setResizable(false);
            tblTipoDeCarroceria.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblTipoDeCarroceria.getColumnModel().getColumn(2).setResizable(false);
            tblTipoDeCarroceria.getColumnModel().getColumn(2).setPreferredWidth(50);
        }

        chkActivo.setSelected(true);
        chkActivo.setText("Tipo Carroceria Activa");
        ...
        lblidTipoCarroceria.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblidTipoCarroceria.setText("Id. Tipo Carroceria : ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(label1)
                    .addComponent(lblidTipoCarroceria)
                    .addComponent(txtTiposCarrocerias, javax.swing.GroupLayout.PREFERRED_SIZE, 449, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(label1)
                .addGap(1, 1, 1)
                .addComponent(txtTiposCarrocerias, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void tblTipoDeCarroceriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTipoDeCarroceriaMouseClicked
        new Thread(new HiloFcrearTiposDeCarroceria(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblTipoDeCarroceriaMouseClicked

    private void txtTiposCarroceriasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTiposCarroceriasKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
        }
    }//GEN-LAST:event_txtTiposCarroceriasKeyPressed

    private void txtTiposCarroceriasFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTiposCarroceriasFocusGained
        txtTiposCarrocerias.setSelectionStart(0);
        txtTiposCarrocerias.setSelectionEnd(txtTiposCarrocerias.getText().length());
    }//GEN-LAST:event_txtTiposCarroceriasFocusGained
    ...
    public void cancelar() {
        actualizar = false;
        txtTiposCarrocerias.setText("");
        chkActivo.setEnabled(false);
        chkActivo.setSelected(false);
        lblidTipoCarroceria.setVisible(false);
        btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
        jBtnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Create.png"))); // NOI18N
        btnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/grabar.png"))); // NOI18N
        ...
        tblTipoDeCarroceria.setEnabled(true);
    }
    ...
    public void nuevo() {
        if (actualizar) {
            ...
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
            txtTiposCarrocerias.setEnabled(true);
           ...
           jBtnNuevo.setEnabled(false);
            ...
            txtTiposCarrocerias.requestFocus();
            chkActivo.setSelected(true);
            tblTipoDeCarroceria.setEnabled(false);
            btnNuevo.setEnabled(false);
           jBtnNuevo.setEnabled(false);
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
    ...
    public void grabar() throws HeadlessException {
        if (!txtTiposCarrocerias.getText().isEmpty()) {
            int x = JOptionPane.showConfirmDialog(this, "Desea guardar el registro ?", "Guardar registro", 0);
            if (x == 0) {
                new Thread(new HiloFcrearTiposDeCarroceria(ini, this, "guardar")).start();
            }
    ...
    private void chkActivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkActivoActionPerformed
        if (chkActivo.isSelected()) {
            chkActivo.setText("Carroceria activo");
        } else {
            chkActivo.setText("Carroceria No Activo");
        }
    ...
    public javax.swing.JLabel lblidTipoCarroceria;
    public javax.swing.JTable tblTipoDeCarroceria;
    public javax.swing.JTextField txtTiposCarrocerias;
    // End of variables declaration//GEN-END:variables
 public boolean validar() {
        boolean verificado = true;
        mensaje = "";
        if (txtTiposCarrocerias.getText().isEmpty()) {
            mensaje += "No ha colocado el nombre de Tipo Carroceria " + "  \n";
            verificado = false;
        }
    ...
    private boolean guardarRegistroDeCarrocerias() {
        boolean valida = false;
        try {

            CTiposDeCarrocerias carroceria = new CTiposDeCarrocerias(ini);
            carroceria.setNombreCarroceria(txtTiposCarrocerias.getText().trim());
            if (chkActivo.isSelected()) {
                carroceria.setActivoCarroceria(1);
            } else {
                carroceria.setActivoCarroceria(0);
            }
            valida = carroceria.grabarCarrocerias();
            if (valida) {
                new Thread(new HiloListadoDeTiposDeCarrocerias(ini)).start();
                lblidTipoCarroceria.setVisible(true);
                lblidTipoCarroceria.setText("Id. Tipo Carroceria :  " + carroceria.getIdCarroceria());
                fila = new Object[3];
                fila[0] = carroceria.getIdCarroceria();
                fila[1] = carroceria.getNombreCarroceria();
                if (carroceria.getActivoCarroceria() < 1) {
                    fila[2] = false;
                } else {
                    fila[2] = true;
                }

                modelo = (DefaultTableModel) tblTipoDeCarroceria.getModel();
                modelo.addRow(fila);
                btnNuevo.setEnabled(true);
                jBtnNuevo.setEnabled(true);
                btnGrabar.setEnabled(false);
            ...
            Logger.getLogger(FCrearTiposCarrocerias.class.getName()).log(Level.SEVERE, null, ex);
        }
        return valida;
    }

    private boolean actualizarRegistroDeCarrocerias() {
        boolean valida = false;
        try {
            int row = tblTipoDeCarroceria.getSelectedRow();
            lblidTipoCarroceria.setText("Id. Tipo Carroceria :  " + String.valueOf(tblTipoDeCarroceria.getValueAt(row, 0)));
            CTiposDeCarrocerias tiposCarrocerias = new CTiposDeCarrocerias(ini);
            tiposCarrocerias.setIdCarroceria((Integer) tblTipoDeCarroceria.getValueAt(row, 0));
            tiposCarrocerias.setNombreCarroceria(txtTiposCarrocerias.getText().trim());
            if (chkActivo.isSelected()) {
                tiposCarrocerias.setActivoCarroceria(1);
            } else {
                tiposCarrocerias.setActivoCarroceria(1);
            }

            valida = tiposCarrocerias.actualizarCarrocerias(row);

            if (valida) {
                new Thread(new HiloListadoDeTiposDeCarrocerias(ini)).start();
                tblTipoDeCarroceria.setValueAt(tiposCarrocerias.getNombreCarroceria(), row, 1);
                if (tiposCarrocerias.getActivoCarroceria() == 0) {
                    tblTipoDeCarroceria.setValueAt(false, row, 2);
                } else {
                    tblTipoDeCarroceria.setValueAt(true, row, 2);
                }
                lblidTipoCarroceria.setVisible(true);
                lblidTipoCarroceria.setText("Id. Tipo Carroceria :  " + tiposCarrocerias.getIdCarroceria());
                btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
    ...
    public void llenarjTable() throws Exception {
        DefaultTableModel modelo = (DefaultTableModel) tblTipoDeCarroceria.getModel();
        ...
        DefaultTableModel modelo2 = (DefaultTableModel) tblTipoDeCarroceria.getModel();

        for (CTiposDeCarrocerias obj : ini.getListaDeTiposDeCarrocerias()) {
            int filaTabla2 = tblTipoDeCarroceria.getRowCount();
            modelo2.addRow(new Object[tblTipoDeCarroceria.getRowCount()]);
            tblTipoDeCarroceria.setValueAt(obj.getIdCarroceria(), filaTabla2, 0);  // item
            tblTipoDeCarroceria.setValueAt(obj.getNombreCarroceria(), filaTabla2, 1); // numero de factura
            if (obj.getActivoCarroceria() == 1) {
                tblTipoDeCarroceria.setValueAt(true, filaTabla2, 2); //
            } else {
                tblTipoDeCarroceria.setValueAt(false, filaTabla2, 2); //
            }
