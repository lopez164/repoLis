 ...
 * @author Usuario
 */
public class FCrearTiposdeServicios  extends javax.swing.JInternalFrame {
...
String mensaje;
Inicio ini;
CTiposDeServicio tiposDeServicios;
...
//private FResidentes residente = (FResidentes)this.getParent();//
 ...
 public FCrearTiposdeServicios(Inicio  ini) {
        initComponents();
        this.ini=ini;
        this.user=ini.getUser();
        this.setResizable(false);
        
        this.setTitle("Formulario para la gestion de Tipos De Servicio");
        lblIdTipoServicio.setText("Id. Tipos De Servicio : ");
        chkActivo.setText("Tipos De Servicio Activo");
        ...
        txtTipoServicio.setEnabled(false);
         new Thread(new HiloFcrearTiposDeServicio(ini, this, "listaDeTiposDeServicio")).start();
 }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Formulario para el ingreso de Tipos de Servicio");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/turbo_64x64.png"))); // NOI18N

        lblNombreTipoServicio.setText("nombre de Tipo de Servicio Veh");

        txtTipoServicio.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtTipoServicioFocusGained(evt);
            }
        });
        txtTipoServicio.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtTipoServicioKeyPressed(evt);
            }
        });
        ...
        tblTipoServicio.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tblTipoServicio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblTipoServicioMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tblTipoServicio);
        if (tblTipoServicio.getColumnModel().getColumnCount() > 0) {
            tblTipoServicio.getColumnModel().getColumn(0).setResizable(false);
            tblTipoServicio.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblTipoServicio.getColumnModel().getColumn(1).setResizable(false);
            tblTipoServicio.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblTipoServicio.getColumnModel().getColumn(2).setResizable(false);
            tblTipoServicio.getColumnModel().getColumn(2).setPreferredWidth(50);
        }

        chkActivo.setSelected(true);
        chkActivo.setText("Tipo Servicio Activo");
        ...
        lblIdTipoServicio.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblIdTipoServicio.setText("Id. Tipo Servicio Veh : ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblNombreTipoServicio)
                    .addComponent(lblIdTipoServicio)
                    .addComponent(txtTipoServicio, javax.swing.GroupLayout.PREFERRED_SIZE, 449, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tblTipoServicioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTipoServicioMouseClicked
        new Thread(new HiloFcrearTiposDeServicio(ini, this, "seleccionarFila")).start();
    }//GEN-LAST:event_tblTipoServicioMouseClicked

    private void txtTipoServicioKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTipoServicioKeyPressed

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
           btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
        }
    }//GEN-LAST:event_txtTipoServicioKeyPressed

    private void txtTipoServicioFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTipoServicioFocusGained
        txtTipoServicio.setSelectionStart(0);
        txtTipoServicio.setSelectionEnd(txtTipoServicio.getText().length());
    }//GEN-LAST:event_txtTipoServicioFocusGained
    ...
    public void cancelar() {
        ...
        lblIdTipoServicio.setVisible(false);
 btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
        jBtnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Create.png"))); // NOI18N
        btnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/grabar.png"))); // NOI18N
       jBtnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Save.png")));
        ...
        tblTipoServicio.setEnabled(true);
    }
    ...
    public void nuevo() {
        if (actualizar) {
            ...
            btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
            txtTipoServicio.setEnabled(true);
            ...
            txtTipoServicio.requestFocus();
            chkActivo.setSelected(true);
            tblTipoServicio.setEnabled(false);
             btnNuevo.setEnabled(false);
             jBtnNuevo.setEnabled(false);
              btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
     ...
     public void grabar() throws HeadlessException {
        if (!txtTipoServicio.getText().isEmpty()) {
            ...
            if (x == 0) {
                  new Thread(new HiloFcrearTiposDeServicio(ini, this, "guardar")).start();
            }
    ...
    private void chkActivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkActivoActionPerformed
        if(chkActivo.isSelected()){
            chkActivo.setText("Servicio activo");
        }else{
             chkActivo.setText("Servicio No Activo");
        }
    ...
    public javax.swing.JLabel lblIdTipoServicio;
    public javax.swing.JLabel lblNombreTipoServicio;
    public javax.swing.JTable tblTipoServicio;
 ...
 public boolean validar() {
        ...
        mensaje = "";
        if (txtTipoServicio.getText().isEmpty()) {
            mensaje += "No ha colocado el nombre de Tipo Servicio " + "  \n";
            verificado = false;
        }
...
private boolean guardarRegistroDeServicio(){
     boolean valida=false;
    try {
       
          CTiposDeServicio servicio = new CTiposDeServicio(ini);  
          servicio.setNombreTipoDeServicio(txtTipoServicio.getText().trim());
          if(chkActivo.isSelected()){
           servicio.setActivoTipoDeServicio(1);
          }else{
               servicio.setActivoTipoDeServicio(0);
          }
          valida=servicio.grabarTipoDeServicios();
          if(valida){
              new Thread(new HiloListadoDeTiposDeServicio(ini)).start();
              
             lblIdTipoServicio.setVisible(true);
             lblIdTipoServicio.setText("Id. Tipo Servicio Veh :  " + servicio.getIdTipoDeServicio());  
              fila = new Object[3];
                    fila[0] = servicio.getIdTipoDeServicio();
                    fila[1] = servicio.getNombreTipoDeServicio();
                    if(servicio.getActivoTipoDeServicio()<1){
                       fila[2] = false;
                    }else{
                       fila[2] = true; 
                    }
                   
                    modelo = (DefaultTableModel) tblTipoServicio.getModel();
                    modelo.addRow(fila);
                    btnNuevo.setEnabled(true);
                    jBtnNuevo.setEnabled(true);
                    btnGrabar.setEnabled(false);
        ...
        Logger.getLogger(FCrearTiposdeServicios.class.getName()).log(Level.SEVERE, null, ex);
    }
    return valida;
}

private boolean actualizarRegistroDeServicio(){
     boolean valida=false;
    try {
         int row=tblTipoServicio.getSelectedRow();
         lblIdTipoServicio.setText("Id. Tipo Servicio Veh :  " + String.valueOf(tblTipoServicio.getValueAt(row, 0)));
          CTiposDeServicio servicio = new CTiposDeServicio(ini); 
          servicio.setIdTipoDeServicio((Integer)tblTipoServicio.getValueAt(row, 0));
          servicio.setNombreTipoDeServicio(txtTipoServicio.getText().trim());
          if(chkActivo.isSelected()){
           servicio.setActivoTipoDeServicio(1);
          }else{
          ...
          valida=servicio.actualizarTipoDeServicios();
          
           if(valida){
                new Thread(new HiloListadoDeTiposDeServicio(ini)).start();
             tblTipoServicio.setValueAt(servicio.getNombreTipoDeServicio(), row, 1);
             if (servicio.getActivoTipoDeServicio()== 0) {
                   tblTipoServicio.setValueAt(false, row, 2);
               } else {
                   tblTipoServicio.setValueAt(true, row, 2);
               }
             lblIdTipoServicio.setVisible(true);
             lblIdTipoServicio.setText("Id. Tipo Servicio Veh :  " + servicio.getIdTipoDeServicio());  
             btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
