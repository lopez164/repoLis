 ...
 * @author Usuario
 */
public class FCrearTiposdeVehiculos  extends javax.swing.JInternalFrame {
...
String mensaje;
Inicio ini;
CTiposDeVehiculos tiposDevehiculos;
...
//private FResidentes residente = (FResidentes)this.getParent();//
 ...
 public FCrearTiposdeVehiculos(Inicio  ini) {
        initComponents();
        this.ini=ini;
        ...
        txtTipoVehiculo.setEnabled(false);
          new Thread(new HiloFcrearTiposDeVehiculos(ini, this, "listaDeTiposDeVehiculo")).start();
 }
    ...
    private void initComponents() {
        ...
        lblNombreTipoVehiculo.setText("nombre de Tipo de Vehiculo");
        ...
        tblTipoVehiculo.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nombre Tipo Vehiculo", "Activo"
            }
        ) {
        ...
        tblTipoVehiculo.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        ...
        if (tblTipoVehiculo.getColumnModel().getColumnCount() > 0) {
            ...
            tblTipoVehiculo.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblTipoVehiculo.getColumnModel().getColumn(1).setResizable(false);
            tblTipoVehiculo.getColumnModel().getColumn(1).setPreferredWidth(300);
            tblTipoVehiculo.getColumnModel().getColumn(2).setResizable(false);
            tblTipoVehiculo.getColumnModel().getColumn(2).setPreferredWidth(50);
        }

        chkActivo.setSelected(true);
        chkActivo.setText("Tipo Vehiculo Activo");
        ...
        lblIdTipoVehiculo.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblIdTipoVehiculo.setText("Id. Tipo Vehiculo : ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblNombreTipoVehiculo)
                    .addComponent(lblIdTipoVehiculo)
                    .addComponent(txtTipoVehiculo, javax.swing.GroupLayout.PREFERRED_SIZE, 449, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tblTipoVehiculoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTipoVehiculoMouseClicked
        new Thread(new HiloFcrearTiposDeVehiculos(ini, this, "seleccionarFila")).start();
    ...
    private void txtTipoVehiculoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTipoVehiculoFocusGained
        txtTipoVehiculo.setSelectionStart(0);
        txtTipoVehiculo.setSelectionEnd(txtTipoVehiculo.getText().length());
    ...
    public void cancelar() {
        ...
        lblIdTipoVehiculo.setVisible(false);
 btnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/agregar.png"))); // NOI18N
        jBtnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Create.png"))); // NOI18N
        btnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/grabar.png"))); // NOI18N
       jBtnGrabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aplicacionlogistica/configuracion/imagenes/img16x16/Save.png")));
        ...
        tblTipoVehiculo.setEnabled(true);
    }
    ...
    public void nuevo() {
        if (actualizar) {
            ...
            txtTipoVehiculo.requestFocus();
            chkActivo.setSelected(true);
            tblTipoVehiculo.setEnabled(false);
             btnNuevo.setEnabled(false);
             jBtnNuevo.setEnabled(false);
              btnGrabar.setEnabled(true);
            jBtnGrabar.setEnabled(true);
    ...
    public void grabar() throws HeadlessException {
        if (!txtTipoVehiculo.getText().isEmpty()) {
            ...
            if (x == 0) {
                 new Thread(new HiloFcrearTiposDeVehiculos(ini, this, "guardar")).start();
            }
    ...
    private void chkActivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkActivoActionPerformed
        if(chkActivo.isSelected()){
            chkActivo.setText("Tipo Vehiculo activo");
             ...
             chkActivo.setText("Tipo Vehiculo No Activo");
        }
    ...
    public javax.swing.JLabel lblIdTipoVehiculo;
    public javax.swing.JLabel lblNombreTipoVehiculo;
...
private boolean guardarRegistroDeTipoVehiculo(){
     boolean valida=false;
    try {
       
          CTiposDeVehiculos tipoVehiculo = new CTiposDeVehiculos(ini);  
          tipoVehiculo.setNombreTipoDeVehiculo(txtTipoVehiculo.getText().trim());
          if(chkActivo.isSelected()){
          ...
          if(valida){
             ...
             lblIdTipoVehiculo.setVisible(true);
             lblIdTipoVehiculo.setText("Id. Tipo vehiculo :  " + tipoVehiculo.getIdTipoDeVehiculo());  
              fila = new Object[3];
                    fila[0] = tipoVehiculo.getIdTipoDeVehiculo();
                    fila[1] = tipoVehiculo.getNombreTipoDeVehiculo();
                    if(tipoVehiculo.getActivoTipoDeVehiculo()<1){
                       fila[2] = false;
                    }else{
                       fila[2] = true; 
                    }
                   
                    modelo = (DefaultTableModel) tblTipoVehiculo.getModel();
                    modelo.addRow(fila);
                    btnNuevo.setEnabled(true);
                    jBtnNuevo.setEnabled(true);
                    btnGrabar.setEnabled(false);
        ...
        Logger.getLogger(FCrearTiposdeVehiculos.class.getName()).log(Level.SEVERE, null, ex);
    }
    return valida;
}

private boolean actualizarRegistroDeTipoVehiculo(){
     boolean valida=false;
    try {
         int row=tblTipoVehiculo.getSelectedRow();
         lblIdTipoVehiculo.setText("Id. Tipo Vehiculo :  " + String.valueOf(tblTipoVehiculo.getValueAt(row, 0)));
          CTiposDeVehiculos tipoVehiculo = new CTiposDeVehiculos(ini); 
          tipoVehiculo.setIdTipoDeVehiculo((Integer)tblTipoVehiculo.getValueAt(row, 0));
          tipoVehiculo.setNombreTipoDeVehiculo(txtTipoVehiculo.getText().trim());
          if(chkActivo.isSelected()){
           tipoVehiculo.setActivoTipoDeVehiculo(1);
          }else{
          ...
          valida=tipoVehiculo.actualizarTipoDeVehiculos();
           ...
           if(valida){
             ...
             tblTipoVehiculo.setValueAt(tipoVehiculo.getNombreTipoDeVehiculo(), row, 1);
              if (tipoVehiculo.getActivoTipoDeVehiculo()== 0) {
                   tblTipoVehiculo.setValueAt(false, row, 2);
               } else {
                   tblTipoVehiculo.setValueAt(true, row, 2);
               }
             lblIdTipoVehiculo.setVisible(true);
             lblIdTipoVehiculo.setText("Id. Tipo Vehiculo :  " + tipoVehiculo.getIdTipoDeVehiculo());
