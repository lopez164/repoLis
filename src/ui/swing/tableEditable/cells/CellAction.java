...
public class CellAction extends TableCustomCell {
    ...
    private void addEvent(final TableCustom table, final TableRowData data, final int row) {
        cmdEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                if (data.isEditing()) {
                    table.cancelEditRowAt(row);
                    cmdEdit.setIcon(new ImageIcon(getClass().getResource("/ui/swing/icons/edit_blue.png")));
                } else {
                    table.editRowAt(row);
                    cmdEdit.setIcon(new ImageIcon(getClass().getResource("/ui/swing/icons/cancel.png")));
                }
            }
        });
    ...
    private void initComponents() {
        ...
        cmdEdit = new ui.swing.button.Button();
        cmdDelete = new ui.swing.button.Button();

        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/swing/icons/edit_blue.png"))); // NOI18N

        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/swing/icons/delete.png"))); // NOI18N
    ...
    private ui.swing.button.Button cmdDelete;
    private ui.swing.button.Button cmdEdit;
